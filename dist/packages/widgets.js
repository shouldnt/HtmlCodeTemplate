			...
			(function(t) {
								...
								(u.src = (function(t) {
									return (
										...
										'.' +
										{
											...
											7: 'faba1cdc1d0b60d30bd0cf4ea438c3e8'
										}[t] +
										'.js'
									);
								})(t)),
				...
				function(t, e, n) {
					...
					t.exports = {
						aug: function(t) {
							return (
								u(arguments).slice(1).forEach(function(e) {
									i(e, function(e, n) {
										t[e] = n;
									});
								}),
				...
				function(t, e, n) {
					...
					t.exports = function(t, e, n) {
						...
						return (
							(t = t || []),
							(e = e || {}),
							(d = 'ƒ(' + t.join(', ') + ', target, [options]);'),
							function() {
								var l,
									f,
									h,
									p,
									m = Array.prototype.slice.apply(arguments, [ 0, t.length ]),
									v = Array.prototype.slice.apply(arguments, [ t.length ]);
								return (
									v.forEach(function(t) {
										t &&
											(t.nodeType !== Node.ELEMENT_NODE
												? c.isType('function', t) ? (l = t) : c.isType('object', t) && (f = t)
												: (h = t));
									}),
									m.length !== t.length || 0 === v.length
										? (l &&
												c.async(function() {
													l(!1);
												}),
											r.reject(new Error('Not enough parameters. Expected: ' + d)))
										: h
											? ((f = c.aug({}, f || {}, e)),
												t.forEach(function(t) {
													f[t] = m.shift();
												}),
												u.asBoolean(f.dnt) && i.setOn(),
												(p = a.getExperiments().then(function(t) {
				...
				function(t, e, n) {
					var r = n(9),
						...
						s = [
							...
							'https://localhost.twitter.com:8080',
				...
				function(t, e, n) {
					...
					t.exports = {
						...
						hasLocalStorageSupport: function() {
							try {
								return (
									s.localStorage.setItem('local_storage_support_test', 'true'),
						...
						t.params({
							...
							t.define('poll', function(t, e) {
								...
								return (
									...
									i.fetch(this.pollEndpoint, r, o, this.cbId(e)).then(h, p)
								);
							});
					};
				},
				...
				function(t, e, n) {
					...
					t.exports = {
						...
						formatClientEventData: function(t, e, n) {
							...
							return (
								((t = m('tfw_client_event', t, i)).client_version = l),
						...
						splitLogEntry: function(t) {
							...
							return t.item_ids && t.item_ids.length > 1
								? ((e = Math.floor(t.item_ids.length / 2)),
									...
									[
										s.aug({}, t, { item_ids: n, item_details: r }),
										s.aug({}, t, { item_ids: i, item_details: o })
									])
								: [ t ];
						},
						...
						getActiveExperimentDataString: function() {
							return s().then(function(t) {
								var e = Object.keys(t).reduce(function(e, n) {
									...
									return (
										t[n].version &&
											((r = n.split('_').slice(-1)[0]), e.push(r + ';' + t[n].bucket)),
										e
									);
								}, []);
								return i(e.join(','));
				...
				function(t, e, n) {
					...
					function d(t, e, n, r) {
						...
						!(function(t, e, n, r) {
							t.id &&
								((s[t.id] = s[t.id] || []), s[t.id].push({ el: t, listener: e, type: n, rootId: r }));
						})(t, i, e, r),
							...
							if (0 !== t.length) {
								...
								(e = r(t, function(t) {
									...
									n &&
										n.length > 0 &&
										((n = n.slice(0, 1)),
										o.canFlushOneItem(n[0]) || (n[0].input.data.message = ''),
										c(n)),
									a &&
										(u(a)
											? c
				...
				function(t) {
					t.exports = { version: '708eecd:1570046592825' };
				},
				function(t, e, n) {
					var r,
						i = n(10),
 ...
 */ var r;
				...
				function(t, e, n) {
					...
					t.exports = function(t, e, n, d) {
						var l;
						return d
							? ((l = i.createElement('div')), new r(s, o, c.TWEET, t, e, n, { sandboxWrapperEl: l }))
				...
				function(t) {
					t.exports = {
						tweetButtonHtmlPath: '/widgets/tweet_button.e3a0e1b01ae601b6c9cf798a93ab7e69.{{lang}}.html',
						followButtonHtmlPath: '/widgets/follow_button.e3a0e1b01ae601b6c9cf798a93ab7e69.{{lang}}.html',
						hubHtmlPath: '/widgets/hub.html',
						widgetIframeHtmlPath: '/widgets/widget_iframe.e3a0e1b01ae601b6c9cf798a93ab7e69.html',
				...
				function(t, e, n) {
					...
					(o.prototype.assert = function(t, e) {
						...
						(o.prototype.require = function(t) {
							var e = this;
							return (
								(t = Array.isArray(t) ? t : i.toRealArray(arguments)).forEach(function(t) {
									e.assert(
										(function(t) {
											return function(e) {
				...
				function(t, e, n) {
					...
					function w(t, e) {
						var n, i;
						return (
							(t = (t = t || r.body).length ? h.toRealArray(t) : [ t ]),
							d.pause(),
							(i = (function(t, e) {
								return t.reduce(function(t, n) {
									return t.concat(
							...
							v.emitter.trigger(v.ALL_WIDGETS_RENDER_START, { widgets: i }),
							(n = s
								.allResolved(
									i.map(function(t) {
								...
								.then(function(t) {
									l.trigger('loaded', { widgets: t }),
										t && t.length && v.emitter.trigger(v.ALL_WIDGETS_RENDER_END, { widgets: t });
								})),
							s.always(n, function() {
								d.resume();
							}),
				...
				function(t, e, n) {
					...
					(c.fromRawTask = function(t) {
						...
						(c.prototype.success = function() {
							o.trigger('rendered', { target: this._sandbox.sandboxEl }),
				...
				function(t, e, n) {
					...
					t.exports = {
						load: function() {
							var t, e, n, s;
							if (c.ie9() || c.ie10() || ('http:' !== l.protocol && 'https:' !== l.protocol))
								return (
							...
							(t = { origin: l.origin }),
								u.settings().indexOf('localhost') > -1 && (t.localSettings = !0),
								(e = v.url(i.resourceBaseUrl + i.widgetIframeHtmlPath, t)),
								(n = function(t) {
									var n;
									if (e.substr(0, t.origin.length) === t.origin && w.isTwitterURL(t.origin))
										try {
											(n = 'string' == typeof t.data ? d.parse(t.data) : t.data).namespace ===
												h.settings && ((r = E(n.settings)), _().resolve());
										} catch (t) {
											f.devError(t);
										}
								}),
								b.addEventListener('message', n),
								(s = o({ src: e, title: 'Twitter settings iframe' }, { display: 'none' })),
								...
								_().promise
									.then(function() {
										e &&
											e.name &&
											e.assignment &&
											(((n = {})[e.name] = { bucket: e.assignment }),
											(r.experiments = y.aug(r.experiments, n))),
											t.resolve(r);
									})
									.catch(function(e) {
										t.reject(e);
				...
				function(t, e, n) {
					...
					t.exports = function(t, e) {
						...
						new i()
							...
							.bind('twttr.private.trigger', n)
							.bind('twttr.private.resizeButton', c),
							new i()
				...
				function(t, e, n) {
					var r,
						...
						function() {
							return (
								i.toRealArray(arguments).slice(1).forEach(function(t) {
									i.isType('object', t) &&
				...
				function(t, e, n) {
					...
					function c(t) {
						return function() {
							return (
								r.toRealArray(arguments).slice(1).forEach(function(t) {
									r.isType('object', t) &&
